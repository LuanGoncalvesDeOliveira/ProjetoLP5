 ...
 * @author u07345492109
 */
public class PesquisaProdutos extends java.awt.Dialog {

    /**
     * Creates new form PesquisaProdutos
     */
    public PesquisaProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jTxtPesquisa, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaProdutos dialog = new PesquisaProdutos(new java.awt.Frame(), true);

 ...
 * @author u07345492109
 */
public class PesquisaUsuarios extends java.awt.Dialog {

    /**
     * Creates new form PesquisaUsuarios
     */
    public PesquisaUsuarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jTxtPesquisa, javax.swing.GroupLayout.DEFAULT_SIZE, 229, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Codigo", "Ativo", "Nivel", "Apelido", "Senha"
            }
        ));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaUsuarios dialog = new PesquisaUsuarios(new java.awt.Frame(), true);
